...
agentDescription: "Use this skill whenever the user asks to test, validate, UAT, regression-check, or investigate the behaviour of a browser-based application — including Copilot Studio agents, Power Platform apps and flows, Dataverse, Dynamics 365, Microsoft 365 admin centres, Teams web, and custom web apps. Covers test charter design, Playwright-driven execution, screenshot evidence capture, expected-vs-observed analysis, and stakeholder reporting. Use it BEFORE claiming any UI behaviour works or is broken. Do NOT use this skill for unit tests, API-only contract tests, or load testing."
platforms: [Scout]
tags: [testing, uat, playwright, quality, copilot-studio, power-platform, automation]
author: Al Macey
authorUrl: "https://github.com/amacey-msft"
authorGithub: amacey-msft
version: 1.0.0
