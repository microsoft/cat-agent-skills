...
description: >-
  ...
  "make slides from this markdown", "convert this page to markdown"). Run the
  bundled scripts/convert.py instead of writing ad-hoc conversion code, BEFORE
  attempting any conversion yourself.
---
