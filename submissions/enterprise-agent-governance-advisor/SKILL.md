...
| **Pursue a custom product/agent route** | The need requires a custom runtime or models, deterministic orchestration, external customer/public reach, nonstandard identity or channels, or an existing external product. | A configured or governed advanced agent can meet all hard requirements without those additional burdens. |
