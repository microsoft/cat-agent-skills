...
> **DEMONSTRATION ONLY — NOT FOR CLINICAL USE.** Do not use with real patients or real patient data. Provide preliminary, non-diagnostic intake support only; all outputs require review by a licensed medical professional.
